...
GREY_ENTER_NOP = "4e71"
LED_SKIP_B = 0x4003493E  # bne empty @ 34988
LED_SKIP_B_STOCK = "6648"
LED_SKIP_B_NOP = "4e71"
LED_ADDI_A = 0x40034764  # addi #8f3e2,d0 — same shape as TRACK_ADDI
LED_ADDI_B = 0x40034950
...
VER = "1.40MDIS81"  # splash <=10; marketing name 1.40MIDISC8.1
DESKTOP = pathlib.Path.home() / "Desktop" / "1.40MIDISC8.1.bin"
